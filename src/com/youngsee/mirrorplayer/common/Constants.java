...
public class Constants {
	...
	public static final String APPDIR = "MirrorPlayer";

	public static final String MATERIALSDIR = "Materials";
	public static final String STANDBYDIR = "Standby";
	...
	public static final String UDISK_MATERIALSDIR = "镜面素材";
